...
class Cone(Shape):
    ...
    def __init__(self, position, shaderProg, scale, color=ColorType.YELLOW, lowPoly=False):
        """
        :param position: location of the object
        :type position: Point
        :param shaderProg: compiled shader program
...
class Cylinder(Shape):
    ...
    def __init__(self, position, shaderProg, scale, color=ColorType.GREEN, lowPoly=False):
        """
        :param position: location of the object
        :type position: Point
        :param shaderProg: compiled shader program
